                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <%--<li class="active"><a href="#tabSubmitted" role="tab" data-toggle="tab">Submitted</a></li>--%>
                                        <li class="active dashboardtab"><a href="#tabInitialReview" role="tab" data-toggle="tab">AAO Initial Review</a></li>
                                        ...
                                        <li class="dashboardtab"><a href="#tabDraft" role="tab" data-toggle="tab">Draft</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <%--<div role="tabpanel" class="tab-pane active fade in" id="tabSubmitted">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <WebPartPages:WebPartZone runat="server" Title="Submitted" ID="WPZSubmitted">
                                                        <ZoneTemplate></ZoneTemplate>
                                                    </WebPartPages:WebPartZone>
                                                </div>
                                            </div>
                                        </div>--%>
                                        <div role="tabpanel" class="tab-pane active fade in" id="tabInitialReview">
                                            <div class="container-fluid">
                                                <div class="row">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="tabApproval">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <WebPartPages:WebPartZone runat="server" Title="Feedback" ID="WPZApproval">
                                                        <ZoneTemplate></ZoneTemplate>
                                                    </WebPartPages:WebPartZone>
                                                </div>
                                            </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="tabDraft">
                                            <div class="container-fluid">
                                                <div class="row">
