...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
	<div class="container-fluid">
        <div class="row">
    	    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 text-center webpartcontainer">
    		    <WebPartPages:WebPartZone runat="server" Title="R1C1" ID="WPZR1C1"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
    	    </div>
    	    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 text-center webpartcontainer">
