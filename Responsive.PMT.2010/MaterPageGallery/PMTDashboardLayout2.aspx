...
<asp:Content ContentPlaceholderID="PlaceHolderAdditionalPageHead" runat="server">
	<SharePointWebControls:UIVersionedContent UIVersion="4" runat="server">
		<ContentTemplate>
            ...
            <link rel="stylesheet" type="text/css" href="https://hq.tradoc.army.mil/sites/PMT/SiteAssets/css/custom_flatforms.css"/>
	        <link rel="stylesheet" type="text/css" href="https://hq.tradoc.army.mil/sites/PMT/SiteAssets/css/jquery-ui.min.css"/>
	        <link rel="stylesheet" type="text/css" href="https://hq.tradoc.army.mil/sites/PMT/SiteAssets/css/jquery.powertip.min.css"/>
	        <link rel="stylesheet" type="text/css" href="https://hq.tradoc.army.mil/sites/PMT/SiteAssets/css/default_Dashboard.css"/>
            ...
            <script type="text/javascript" src="https://hq.tradoc.army.mil/sites/PMT/SiteAssets/js/moment.js" ></script>
	        <script type="text/javascript" src="https://hq.tradoc.army.mil/sites/PMT/SiteAssets/js/moment-timezone.min.js" ></script>
	        <script type="text/javascript" src="https://hq.tradoc.army.mil/sites/PMT/SiteAssets/js/jquery.powertip.min.js" ></script>
	        <script type="text/javascript" src="https://hq.tradoc.army.mil/sites/PMT/SiteAssets/js/jquery-ui.min.js" ></script>
            <script type="text/javascript" src="https://hq.tradoc.army.mil/sites/PMT/SiteAssets/js/ValidateUser.js"></script>
	        <script type="text/javascript" src="https://hq.tradoc.army.mil/sites/PMT/SiteAssets/js/PMT.js"></script>
	        <script type="text/javascript" src="https://hq.tradoc.army.mil/sites/PMT/SiteAssets/js/default_Dashboard.js"></script>
		</ContentTemplate>
