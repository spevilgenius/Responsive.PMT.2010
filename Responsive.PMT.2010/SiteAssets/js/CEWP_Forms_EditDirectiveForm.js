...
CKO.FORMS.DIRECTIVES.EditForm= function () {
    ...
    function LoadData() {
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
            ...
            if (target === "#tabPhases") {
                //var h = $("#EditForm").height() - 50 + "px";
                var h = "500px";
                var w = $("#EditForm").width() - 10 + "px";
                logit("w: " + w + ", h: " + h);
                $("#Phases").css({ "height": h });
                $("#Phases").css({ "width": w });
                if (!v.phasesdrawn) {
    ...
    function GetPhases() {
        ...
        var basedata = '{"data":[{"id":1,"start_date":"' + moment().format("MM/DD/YYYY") + '","duration":5,"text":"Assess","progress":1,"parent":0,"open":false,"end_date":"' + moment().add(5, "days").format("MM/DD/YYYY") + '"}]}';
        ...
        // drw 9/18/2018
        if (v.ganttdata && v.ganttdata.length > 10) {
